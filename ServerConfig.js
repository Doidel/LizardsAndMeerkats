var config = {
	include: [
        ...
        {name: 'GearElement', path: './gameClasses/GearElement'},
        {name: 'GearToolElement', path: './gameClasses/GearToolElement'},
        {name: 'GearWeaponElement', path: './gameClasses/GearWeaponElement'},
        {name: 'GearArmorElement', path: './gameClasses/GearArmorElement'},
