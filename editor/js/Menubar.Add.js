Menubar.Add = function ( editor ) {
	...
	function onHeightfieldOptionClick () {

		var width = 200;
		var height = 200;

		var widthSegments = heightSegments = 512;

		var geometry = new THREE.PlaneGeometry( width, height, widthSegments - 1, heightSegments - 1 );
		//geometry.computeVertexNormals();
		//geometry.computeFaceNormals();
		geometry.heightfield = true;
		var material = Physijs.createMaterial(
		...
		p = geometry;
		var mesh = new Physijs.HeightfieldMesh( geometry, material );
		//var mesh = new THREE.Mesh(geometry, new THREE.MeshPhongMaterial());
		mesh.rotation.x = -Math.PI / 2;
		mesh.receiveShadow = true;
		mesh.castShadow = true;
		mesh.name = 'Heightfield ' + ( ++ meshCount );
	...
	var menuConfig = [
		...
		createOption( 'Heightfield', onHeightfieldOptionClick ),
